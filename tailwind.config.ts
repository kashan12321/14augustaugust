	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'patriotic-pulse': {
					'0%, 100%': { transform: 'scale(1)', boxShadow: '0 0 20px hsl(var(--primary) / 0.5)' },
					'50%': { transform: 'scale(1.05)', boxShadow: '0 0 40px hsl(var(--primary) / 0.8)' }
				},
				'fade-in': {
